...
public class TVShowServiceTest {
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonShow> response = client.target(TestConstants.SERVER_ROOT + svc_root)
    ...
    public void callCreate() throws Exception {
        ...
        JsonShow response = client.target(TestConstants.SERVER_ROOT + svc_root).request(MediaType.APPLICATION_JSON)
