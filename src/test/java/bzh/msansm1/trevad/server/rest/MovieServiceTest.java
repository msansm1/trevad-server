...
public class MovieServiceTest {
    ...
    private static final String svc_root = "/api/v1/movies";
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonMovie> response = client.target(TestConstants.SERVER_ROOT + svc_root)
    ...
    public void callGetOne() throws Exception {
        ...
        JsonMovie response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1/loguser/1")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(JsonMovie.class);
    ...
    public void callCreate() throws Exception {
        ...
        JsonMovie response = client.target(TestConstants.SERVER_ROOT + svc_root).request(MediaType.APPLICATION_JSON)
    ...
    public void callGetListParamsPOne() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonMovie> response = client
                .target(TestConstants.SERVER_ROOT + svc_root + "?from=0&limit=5&orderBy=id&orderDir=asc")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        assertFalse("No movie found", response.isEmpty());
    ...
    public void callGetListParamsPTwo() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonMovie> response = client
                .target(TestConstants.SERVER_ROOT + svc_root + "?from=6&limit=5&orderBy=id&orderDir=asc")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        assertFalse("No movie found", response.isEmpty());
