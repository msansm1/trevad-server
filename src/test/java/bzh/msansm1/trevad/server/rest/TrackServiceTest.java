...
public class TrackServiceTest {
    ...
    private static final String svc_root = "/api/v1/tracks";
    ...
    public void callGetAlbumTracks() throws Exception {
        ...
        List<JsonTrack> response = client.target(TestConstants.SERVER_ROOT + svc_root + "/album/1")
    ...
    public void callGetOne() throws Exception {
        ...
        JsonTrack response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(JsonTrack.class);
    ...
    public void callCreate() throws Exception {
        ...
        JsonTrack response = client.target(TestConstants.SERVER_ROOT + svc_root).request(MediaType.APPLICATION_JSON)
