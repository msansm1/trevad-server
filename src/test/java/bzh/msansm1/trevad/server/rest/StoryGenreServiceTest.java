...
/**
 * Test class for storygenre REST service
 * 
 * @author msansm1
 *
 */
...
public class StoryGenreServiceTest {
    ...
    private static final String svc_root = "/api/v1/storygenres";
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonStorygenre> response = client.target(TestConstants.SERVER_ROOT + svc_root)
    ...
    public void callGetOne() throws Exception {
        ...
        JsonStorygenre response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
    ...
    public void callCreate() throws Exception {
        ...
        JsonStorygenre response = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
    ...
    public void callDelete() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonStorygenre> listbefore = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        ...
        @SuppressWarnings("unchecked")
        List<JsonStorygenre> listafter = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
