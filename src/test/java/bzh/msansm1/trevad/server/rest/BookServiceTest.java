...
public class BookServiceTest {
    ...
    private static final String svc_root = "/api/v1/books";
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonBook> response = client.target(TestConstants.SERVER_ROOT + svc_root)
    ...
    public void callCreate() throws Exception {
        ...
        JsonBook response = client.target(TestConstants.SERVER_ROOT + svc_root).request(MediaType.APPLICATION_JSON)
