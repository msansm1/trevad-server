...
public class EditorServiceTest {
    ...
    private static final String svc_root = "/api/v1/editors";
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonEditor> response = client.target(TestConstants.SERVER_ROOT + svc_root)
    ...
    public void callGetOne() throws Exception {
        ...
        JsonEditor response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
    ...
    public void callCreate() throws Exception {
        ...
        JsonEditor response = client.target(TestConstants.SERVER_ROOT + svc_root).request(MediaType.APPLICATION_JSON)
    ...
    public void callDelete() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonEditor> listbefore = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        ...
        @SuppressWarnings("unchecked")
        List<JsonEditor> listafter = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
