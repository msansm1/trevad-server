...
public class ArtistServiceTest {
    ...
    private static final String svc_root = "/api/v1/artists";
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonArtist> response = client.target(TestConstants.SERVER_ROOT + svc_root)
    ...
    public void callGetOne() throws Exception {
        ...
        JsonArtist response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
    ...
    public void callCreate() throws Exception {
        ...
        JsonArtist response = client.target(TestConstants.SERVER_ROOT + svc_root).request(MediaType.APPLICATION_JSON)
    ...
    public void callGetListForAlbums() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonArtist> response = client.target(TestConstants.SERVER_ROOT + svc_root + "/albums")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        assertFalse("No artist found", response.isEmpty());
    }
    ...
    public void callGetListForBooks() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonArtist> response = client.target(TestConstants.SERVER_ROOT + svc_root + "/books")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        assertFalse("No artist found", response.isEmpty());
    }
    ...
    public void callGetListForMovies() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonArtist> response = client.target(TestConstants.SERVER_ROOT + svc_root + "/movies")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        assertFalse("No artist found", response.isEmpty());
    }
    ...
    public void callGetListForSeries() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonArtist> response = client.target(TestConstants.SERVER_ROOT + svc_root + "/series")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        assertFalse("No artist found", response.isEmpty());
    }
