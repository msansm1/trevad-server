...
public class AuthServiceTest {
    ...
    private static final String svc_root = "/api/v1/auth";
    ...
    public void callLoginOK() throws Exception {
        ...
        JsonAuth response = client.target(TestConstants.SERVER_ROOT + svc_root + "/login")
    ...
    public void callLogin401() throws Exception {
        ...
        Response response = client.target(TestConstants.SERVER_ROOT + svc_root + "/login")
    ...
    public void callLogout() throws Exception {
        ...
        Response response = client.target(TestConstants.SERVER_ROOT + svc_root + "/logout")
