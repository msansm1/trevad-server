...
/**
 * Test class for booktype REST service
 * 
 * @author msansm1
 *
 */
...
public class BookTypeServiceTest {
    ...
    private static final String svc_root = "/api/v1/booktypes";
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonBooktype> response = client.target(TestConstants.SERVER_ROOT + svc_root)
    ...
    public void callGetOne() throws Exception {
        ...
        JsonBooktype response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
    ...
    public void callCreate() throws Exception {
        ...
        JsonBooktype response = client.target(TestConstants.SERVER_ROOT + svc_root).request(MediaType.APPLICATION_JSON)
    ...
    public void callDelete() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonBooktype> listbefore = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        ...
        @SuppressWarnings("unchecked")
        List<JsonBooktype> listafter = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
