...
public class FriendServiceTest {
    ...
    private static final String svc_root = "/api/v1/friends";
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonFriend> response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1")
    ...
    public void callDelete() throws Exception {
        ...
        JsonSimpleResponse response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1/3/delete")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
