...
public class ArtistTypeServiceTest {
    ...
    private static final String svc_root = "/api/v1/artisttypes";
    ...
    public void callGetList() throws Exception {
        ...
        List<JsonArtisttype> response = client.target(TestConstants.SERVER_ROOT + svc_root)
    ...
    public void callGetOne() throws Exception {
        ...
        JsonArtisttype response = client.target(TestConstants.SERVER_ROOT + svc_root + "/1")
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
    ...
    public void callDelete() throws Exception {
        ...
        @SuppressWarnings("unchecked")
        List<JsonArtisttype> listbefore = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
        ...
        @SuppressWarnings("unchecked")
        List<JsonArtisttype> listafter = client.target(TestConstants.SERVER_ROOT + svc_root)
                .request(MediaType.APPLICATION_JSON).header(Constants.HTTP_HEADER_TOKEN, TestConstants.USER_TOKEN)
                .get(List.class);
