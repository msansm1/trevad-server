...
public class LoanService extends Application {
    ...
    public Response getOne(@PathParam(value = "id") Integer id) {
        ...
        if (l == null) {
            return Response.status(Response.Status.NOT_FOUND).entity("No loan found").build();
        }
        ...
        return Response.status(Response.Status.OK).entity(jl).build();
    }
