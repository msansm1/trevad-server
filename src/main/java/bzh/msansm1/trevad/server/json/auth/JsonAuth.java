package bzh.msansm1.trevad.server.json.auth;
...
public class JsonAuth {
    ...
    public JsonAuth(Integer id, String login, String email, String oldpassword, String newpassword,
            String newconfpassword, String token) {
        super();
        this.id = id;
        this.login = login;
        this.email = email;
