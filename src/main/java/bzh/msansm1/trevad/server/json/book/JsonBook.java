package bzh.msansm1.trevad.server.json.book;
...
public class JsonBook {
    ...
    public JsonBook(Integer id, String title, String editor, Integer editorId, String cover, String description,
            Date publicationDate, String genre, Integer genreId, String type, Integer typeId, String lang,
            Integer langId, String series, Integer bookNb, Boolean isSerieDone) {
        super();
        this.id = id;
        this.title = title;
        this.editor = editor;
    ...
    public JsonBook(Integer id, String title, String editor, Integer editorId, String cover, String description,
            Date publicationDate, String genre, Integer genreId, String type, Integer typeId, String lang,
            Integer langId, String series, Integer bookNb, Boolean isSerieDone, Boolean mycollec, Integer rating,
            Boolean signed) {
        super();
        this.id = id;
        this.title = title;
    ...
    public JsonBook(Integer id, String title, String editor, Integer editorId, String collection, Integer collectionId,
            String cover, String description, Date publicationDate, String genre, Integer genreId, String type,
            Integer typeId, String lang, Integer langId, String series, Integer bookNb, Boolean isSerieDone) {
        super();
        this.id = id;
        this.title = title;
        this.editor = editor;
    ...
    public JsonBook(Integer id, String title, String author, Integer authorId, String editor, Integer editorId,
            String collection, Integer collectionId, String cover, String description, Date publicationDate,
            String genre, Integer genreId, String type, Integer typeId, String lang, Integer langId, String series,
            Integer bookNb, Boolean isSerieDone, Boolean mycollec, Integer rating, Boolean signed) {
        super();
        this.id = id;
        this.title = title;
        this.author = author;
