package bzh.msansm1.trevad.server.json.tvshow;
...
public class JsonShow {
    ...
    public JsonShow(Integer id, String title, String description, Date releaseDate, String cover, String length,
            Integer season, String series, Boolean isSeriesDone) {
        super();
        this.id = id;
        this.title = title;
        this.description = description;
    ...
    public JsonShow(Integer id, String title, String description, Date releaseDate, String cover, String support,
            Integer supportId, String genre, Integer genreId, String length, Integer season, String series,
            Boolean isSeriesDone) {
        super();
        this.id = id;
        this.title = title;
        this.description = description;
    ...
    public JsonShow(Integer id, String title, String description, Date releaseDate, String cover, String support,
            Integer supportId, String genre, Integer genreId, String length, Integer season, String series,
            Boolean isSeriesDone, Boolean mycollec, Integer rating) {
        super();
        this.id = id;
        this.title = title;
        this.description = description;
    ...
    public JsonShow(Integer id, String title, String description, Date releaseDate, String cover, String support,
            Integer supportId, String genre, Integer genreId, String length, Integer season, String series,
            Boolean isSeriesDone, List<JsonLang> langs, List<JsonLang> subtitles, Boolean mycollec, Integer rating) {
        super();
        this.id = id;
        this.title = title;
        this.description = description;
