package bzh.msansm1.trevad.server.json.movie;
...
public class JsonMovie {
    ...
    public JsonMovie(Integer id, String title, String description, Date releaseDate, String cover, String support,
            Integer supportId, String genre, Integer genreId, String length, Boolean isCollector) {
        super();
        this.id = id;
        this.title = title;
    ...
    public JsonMovie(Integer id, String title, String description, Date releaseDate, String cover, String support,
            Integer supportId, String genre, Integer genreId, String length, Boolean isCollector, List<JsonLang> langs,
    ...
    public JsonMovie(Integer id, String title, String description, Date releaseDate, String cover, String support,
            Integer supportId, String genre, Integer genreId, String length, Boolean isCollector, Boolean mycollec,
            Integer rating) {
        super();
        this.id = id;
        this.title = title;
    ...
    public JsonMovie(Integer id, String title, String description, Date releaseDate, String cover, String support,
            Integer supportId, String genre, Integer genreId, String length, Boolean isCollector, String realisator,
            Integer realisatorId, String producer, Integer producerId, String scenarist, Integer scenaristId,
            List<JsonLang> langs, List<JsonLang> subtitles, Boolean mycollec, Integer rating) {
        super();
        this.id = id;
        this.title = title;
        this.description = description;
