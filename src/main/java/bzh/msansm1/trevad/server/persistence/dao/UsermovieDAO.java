...
public class UsermovieDAO extends Dao {
    ...
    public List<Usermovie> getUsermovies() {
        return em.createQuery("from Usermovie", Usermovie.class).getResultList();
    }
    ...
    public Usermovie getUsermovie(Integer movieId, Integer userId) {
        TypedQuery<Usermovie> q = em.createQuery("from Usermovie " + "WHERE id.movie=:param1 AND id.user=:param2",
                Usermovie.class);
    ...
    public Usermovie getUsermovie(Integer movieId, String token) {
        TypedQuery<Usermovie> q = em
                .createQuery("from Usermovie " + "WHERE id.movie=:param1 AND userBean.token=:param2", Usermovie.class);
        q.setParameter("param1", movieId);
